...
class PluginLegacy {
    ...
    convertFromV5(c) {
        class V5 extends deps_1.default.Heroku.Command {
            run() {
                return tslib_1.__awaiter(this, void 0, void 0, function* () {
                    const ctx = {
                        ...
                        config: this.config,
                        apiUrl: deps_1.default.Heroku.vars.apiUrl,
                        herokuDir: this.config.cacheDir,
                        apiToken: this.heroku.auth,
                        apiHost: deps_1.default.Heroku.vars.apiHost,
                        gitHost: deps_1.default.Heroku.vars.gitHost,
                        httpGitHost: deps_1.default.Heroku.vars.httpGitHost,
                        cwd: process.cwd(),
                    };
        ...
        if (c.needsApp || c.wantsApp) {
            V5.flags.app = deps_1.default.Heroku.flags.app({ required: !!c.needsApp });
            V5.flags.remote = deps_1.default.Heroku.flags.remote();
        }
        if (c.needsOrg || c.wantsOrg) {
            let opts = { required: !!c.needsOrg, hidden: false, description: 'team to use' };
            if (!V5.flags.team)
                V5.flags.team = deps_1.default.Heroku.flags.team(opts);
            if (!V5.flags.org) {
